        ...
        <div className="overflow-hidden rounded-3xl border border-zinc-200/80 bg-white shadow-[0_24px_80px_rgba(15,23,42,0.10)] ring-1 ring-zinc-950/5">
          <div className="grid items-center lg:grid-cols-2">
            <div className="px-8 py-12 lg:px-12 lg:py-16">
              <p className="mb-3 text-sm font-semibold uppercase tracking-widest text-orange-600">O mnie</p>
              <h2 className="text-3xl font-bold leading-tight tracking-[-0.03em] text-zinc-900 sm:text-4xl">
                Wdrożę asystenta, który ma wspierać sprzedaż, a nie imponować technologią.
              </h2>

              <div className="mt-6 space-y-4">
                <p className="text-lg leading-7 text-zinc-600">
                  Nazywam się Bartek Ząbek. Od ponad 3 lat pracuję jako programista w dużych firmach technologicznych, takich jak Snowflake i Visa, dlatego potrafię przełożyć technologię na stabilne, konkretne rozwiązanie biznesowe.
                </p>
                <p className="text-lg leading-7 text-zinc-600">
                  Przy tej usłudze nie chodzi o samo AI. Chodzi o to, żeby właściciel firmy usługowej nie tracił kontaktu z klientem wtedy, gdy jest w trasie, prowadzi zlecenie, obsługuje innego klienta albo nie może odebrać telefonu po godzinach.
                </p>
                <p className="text-lg leading-7 text-zinc-600">
                  Pracuję bezpośrednio z Tobą: ustalamy, jakie informacje trzeba zebrać, ustawiam scenariusz rozmowy, a potem poprawiamy go na podstawie realnych zgłoszeń.
                </p>
              </div>

              <div className="mt-8 border-l-2 border-orange-500 pl-5">
                <p className="text-base font-semibold text-zinc-900">
                  Prosty cel: więcej uporządkowanych zgłoszeń i mniej pustych nieodebranych połączeń.
                </p>
              </div>
            ...
            <div className="flex flex-col items-center justify-center gap-4 bg-stone-50 px-8 py-12 lg:h-full lg:px-12 lg:py-0">
